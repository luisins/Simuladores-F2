          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs mt-0.5 font-medium">
                Análisis Microscópico de Conducción · Problema G4P7
              </p>
            </div>
          </div>
          <button
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
            {(Object.keys(materiales) as MaterialKey[]).map((key) => {
              ...
              return (
                <button
                  key={key}
                  className={`group relative overflow-hidden transition-all duration-300 p-4 border rounded-2xl text-left cursor-pointer flex flex-col justify-between h-40 ${
                    isSelected
              ...
              <div className="grid grid-cols-3 lg:grid-cols-1 gap-2">
                {[
                  ...
                  <button
                    ...
                    className={`py-2 px-3 border rounded-xl text-left cursor-pointer transition-all ${
                      campoE === p.val
                      ...
                      return (
                        <tr 
                          ...
                          className={`border-b border-slate-100 hover:bg-slate-50/80 cursor-pointer ${
                            material === key ? "bg-indigo-50/40 font-semibold" : ""
                          }`}
                        >
